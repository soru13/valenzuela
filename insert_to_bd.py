...
def run():
    ...
    # areas_responsables = []
    # caracter_procedimientos = []
    # folios = []
    # numeros_identifique_contrato = []
    # montos_sin = []
    # montos_con = []
    # lugar_obras = []
    # descripciones_obras = []
    # fechas_convocatorias = []
    # fechas_contratos = []
    # hiperviculos_comunicado = []
    # hiperviculos_dictamen = []
    # hiperviculos_convocatoria = []
    # hiperviculos_fallo = []
    # hiperviculos_presentacion = []
    # descripcion_justificacion = []
    # objetos_contratos = []
    # fechas_inicio_plazo = []
    # fechas_termino_plazo = []
    # hiperviculos_contrato = []
    # tipos_fondos = []
    # breves_descripcion_obra = []
    # etapas_obra = []
    # mecanismos_vigilancia = []
    # hiperviculos_avance_fianciero = []
    # montos_garantias = []
    # institutos = []
    # estados = []
    # files = []
    ...
    for row in range(1905, (sheet_transparencia_excel.max_row + 1)):
        ...
        # if(row != sheet_transparencia_excel.max_row):
        #     insert += "({},{},{},{},{},'{}',{},{},'{}',{},{},{},{},{},{},{},'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}',{},'{}','{}','{}','{}',{},'{}',{},{},'{}',{},{},'{}',{},'{}',1, current_timestamp, current_timestamp),".format(
        #                 codigos[row-2],
        #                 full_name[row-2],
        #                 ejercicios[row-2],
        #                 tipo_procedimientos[row-2],
        #                 materias[row-2],
        #                 folios[row-2],
        #                 areas_solicitantes[row-2],
        #                 areas_contratantes[row-2],
        #                 numeros_identifique_contrato[row-2],
        #                 montos_sin[row-2],
        #                 montos_con[row-2],
        #                 tipos_monedas[row-2],
        #                 tipos_cambios[row-2],
        #                 formas_pago[row-2],
        #                 origen_recursos[row-2],
        #                 fuentes_financiamiento[row-2],
        #                 lugar_obras[row-2],
        #                 descripciones_obras[row-2],
        #                 fechas_convocatorias[row-2],
        #                 fechas_contratos[row-2],
        #                 hiperviculos_comunicado[row-2],
        #                 hiperviculos_dictamen[row-2],
        #                 hiperviculos_convocatoria[row-2],
        #                 hiperviculos_fallo[row-2],
        #                 hiperviculos_presentacion[row-2],
        #                 descripcion_justificacion[row-2],
        #                 areas_responsables[row-2],
        #                 objetos_contratos[row-2],
        #                 fechas_inicio_plazo[row-2],
        #                 fechas_termino_plazo[row-2],
        #                 hiperviculos_contrato[row-2],
        #                 tipos_fondos[row-2],
        #                 breves_descripcion_obra[row-2],
        #                 etapas_obra[row-2],
        #                 mecanismos_vigilancia[row-2],
        #                 hiperviculos_avance_fianciero[row-2],
        #                 montos_garantias[row-2],
        #                 institutos[row-2],
        #                 estados[row-2],
        #                 caracter_procedimientos[row-2],
        #                 files[row-2])
        # if(row == sheet_transparencia_excel.max_row):
        #     insert += "({},{},{},{},{},'{}',{},{},'{}',{},{},{},{},{},{},{},'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}',{},'{}','{}','{}','{}',{},'{}',{},{},'{}',{},{},'{}',{},'{}',1, current_timestamp, current_timestamp);".format(
        #         codigos[row-2],
        ...
        #         files[row-2])
        #     print(insert)
        #     insertar('transparencia', insert)
        #     # """Con esto iteramos para crear el query de insercción de las personas"""
        #     # for celda in range(0, sheet_transparencia_excel.max_row -1):        
        #     #     if(celda +2 == sheet_transparencia_excel.max_row):
        #     #         print(insert)
