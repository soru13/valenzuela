    ...
    for cur_row in range(salto_row, row_count):
        ...
        if cell.value:
            if(sheet2):
                ...
                sheet_transparencia_excel.cell(row=(maxima_row+cur_row-salto_row-1), column=43, value=name_institute)
...
def iter_columnas(col_count , sheet, maxima_row, row_count, row, salto_inicio, book, sheet2, file, name_institute):
    for cur_col in range(0, col_count):
        transparencia_excel.active = 0
        cell = sheet.cell(row, cur_col)
        if ('ID' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 1, sheet2, True, file, name_institute)
        if (' Ejercicio' == cell.value or 'EJERCICIO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 2, sheet2, True, file, name_institute)
        if (' Tipo de Procedimiento (catálogo)' == cell.value or ' Tipo de Procedimiento' == cell.value or 'TIPO DE PROCEDIMIENTO (CATÁLOGO)' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 3, sheet2, False, file, name_institute)
        if (' Materia' == cell.value or ' Materia O Tipo de Contratación (catálogo)' == cell.value or ' Categoría:' == cell.value or 'MATERIA (CATÁLOGO)' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 4, sheet2, False, file, name_institute)
        if (' Número de Expediente, Folio O Nomenclatura' == cell.value or 'NÚMERO DE EXPEDIENTE  FOLIO O NOMENCLATURA QUE LO IDENTIFIQUE' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 5, sheet2, False, file, name_institute)
        if (' Nombre(s) Del Adjudicado' == cell.value or ' Nombre(s) Del Contratista O Proveedor' ==  cell.value or ' Nombre(s)' == cell.value or 'NOMBRE(S) DEL ADJUDICADO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 6, sheet2, False, file, name_institute)
        if (' Primer Apellido Del Adjudicado' == cell.value or ' Primer Apellido' == cell.value or ' Primer Apellido Del Contratista O Proveedor' == cell.value or 'PRIMER APELLIDO DEL ADJUDICADO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 7, sheet2, False, file, name_institute)
        if (' Segundo Apellido Del Adjudicado' == cell.value or ' Segundo Apellido' == cell.value or ' Segundo Apellido Del Contratista O Proveedor' == cell.value or 'SEGUNDO APELLIDO DEL ADJUDICADO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 8, sheet2, False, file, name_institute)
        ...
        if (' Denominación O Razón Social' == cell.value or
            ...
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 9, sheet2, False, file, name_institute)
        if (' Rfc de La Persona Física O Moral Contratista O Proveedor' == cell.value or ' Registro Federal de Contribuyentes (rfc) de La Persona Física O Moral Adjudicada' == cell.value or 'REGISTRO FEDERAL DE CONTRIBUYENTES (RFC) DE LA PERSONA FÍSICA O MORAL ADJUDICADA' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 10, sheet2, False, file, name_institute)
        if (' Área(s) Solicitante' == cell.value or 'ÁREA(S) SOLICITANTE(S)' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 11, sheet2, False, file, name_institute)
        if (' Área(s) Contratante(s)' == cell.value or ' Unidad Administrativa Contratante' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 12, sheet2, False, file, name_institute)
        if (' Número Que Identifique Al Contrato' == cell.value or 'NÚMERO QUE IDENTIFIQUE AL CONTRATO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 13, sheet2, True, file, name_institute)
        if (' Monto Del Contrato sin Impuestos (en Pesos Mex.)' == cell.value or ' Monto Del Contrato sin Impuestos (en Mxn)' == cell.value or
            ...
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 14, sheet2, True, file, name_institute)
        if (' Monto Total Del Contrato con Impuestos Incluidos' == cell.value or ' Monto Total Del Contrato con Impuestos Incluidos (mxn)' == cell.value or
            ...
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 15, sheet2, True, file, name_institute)
        if (' Tipo de Moneda' == cell.value or 'TIPO DE MONEDA' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 16, sheet2, False, file, name_institute)
        if (' Tipo de Cambio de Referencia, en su Caso' == cell.value or 'TIPO DE CAMBIO DE REFERENCIA  EN SU CASO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 17, sheet2, False, file, name_institute)
        if (' Forma de Pago' == cell.value or 'FORMA DE PAGO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 18, sheet2, False, file, name_institute)
        if (' Origen de Los Recursos Públicos (catálogo)' == cell.value or ' Origen de Los Recursos Públicos' == cell.value or 'ORIGEN DE LOS RECURSOS PÚBLICOS' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 19, sheet2, False, file, name_institute)
        if (' Fuente de Financiamiento' == cell.value or 'FUENTES DE FINANCIAMIENTO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 20, sheet2, False, file, name_institute)
        if (' Lugar Donde Se Realizará La Obra Pública, en su Caso' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 21, sheet2, False, file, name_institute)
        if (' Descripción de Las Obras, Bienes O Servicios' == cell.value or 'DESCRIPCIÓN DE OBRAS  BIENES O SERVICIOS' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 22, sheet2, False, file, name_institute)
        if (' Fecha de La Convocatoria O Invitación' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 23, sheet2, False, file, name_institute)
        if (' Fecha Del Contrato' == cell.value or 'FECHA DEL CONTRATO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 24, sheet2, False, file, name_institute)
        if (' Hipervínculo Al Comunicado de Suspensión, en su Caso' == cell.value or 'HIPERVÍNCULO AL COMUNICADO DE SUSPENSIÓN  RESCISIÓN O TERMINACIÓN ANTICIPADA DEL CONTRATO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 25, sheet2, False, file, name_institute)
        if (' Hipervínculo Al (los) Dictámenes, en su Caso' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 26, sheet2, False, file, name_institute)
        if (' Hipervínculo a La Convocatoria O Invitaciones' == cell.value or ' Hipervínculo a La Convocatoria O Invitaciones Emitidas' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 27, sheet2, False, file, name_institute)
        if (' Hipervínculo Al Fallo de La Junta de Aclaraciones O Al Documento Correspondiente' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 28, sheet2, False, file, name_institute)
        if (' Hipervínculo Al Documento Donde Conste La Presentación Las Propuestas' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 29, sheet2, False, file, name_institute)
        # #obras públicas campo aun faltantes que no tenia
        if (' Descripción de Las Razones Que Justifican su Elección' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 30, sheet2, False, file, name_institute)
        if (' Área(s) Responsable de su Ejecución' == cell.value or 'ÁREA(S) RESPONSABLE(S) DE LA EJECUCIÓN DEL CONTRATO' == cell.value or
            ...
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 31, sheet2, False, file, name_institute)
        if (' Objeto Del Contrato' == cell.value or 'OBJETO DEL CONTRATO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 32, sheet2, False, file, name_institute)
        if (' Fecha de Inicio Del Plazo de Entrega O Ejecución' == cell.value or 'FECHA DE INICIO DEL PLAZO DE ENTREGA O EJECUCIÓN DE SERVICIOS CONTRATADOS U OBRA PÚBLICA' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 33, sheet2, False, file, name_institute)
        if (' Fecha de Término Del Plazo de Entrega O Ejecución' == cell.value or 'FECHA DE TÉRMINO DEL PLAZO DE ENTREGA O EJECUCIÓN DE SERVICIOS U OBRA PÚBLICA' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 34, sheet2, False, file, name_institute)
        if (' Hipervínculo Al Documento Del Contrato Y Anexos, en Versión Pública, en su Caso' == cell.value or
            ...
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 35, sheet2, False, file, name_institute)
        if ('ESTATUS CONTRATO' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 36, sheet2, False, file, name_institute)
        if (' Tipo de Fondo de Participación O Aportación Respectiva' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 37, sheet2, False, file, name_institute)
        if (' Breve Descripción de La Obra Pública, en su Caso' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 38, sheet2, False, file, name_institute)
        if (' Etapa de La Obra Pública Y/o Servicio de La Misma (catálogo)' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 39, sheet2, False, file, name_institute)
        if (' Mecanismos de Vigilancia Y Supervisión de La Ejecución, en su Caso' == cell.value or
            ...
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 40, sheet2, False, file, name_institute)
        if (' Hipervínculo a Los Informes de Avance Financiero, en su Caso' == cell.value or
            ...
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 41, sheet2, False, file, name_institute)
        if (' Monto Total de Garantías Y/o Contragarantías, en Caso de Que Se Otorgaran durante El Procedimiento' == cell.value or
            ...
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 42, sheet2, False, file, name_institute)
        if ('Institucion' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 43, sheet2, False, file, name_institute)
        if ('Municipio/Estado' == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 44, sheet2, False, file, name_institute)
        if (" Carácter Del Procedimiento (catálogo)" == cell.value):
            insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 45, sheet2, False, file, name_institute)
        insertar(row_count, cur_col, maxima_row, sheet, salto_inicio, 46, sheet2, False, file, name_institute)
...
def parse_home():
    for file in os.listdir():
        ...
        transparencia_excel.save("transparencia.xlsx")
        name = sheet.cell(0, 1)
        if (sheet.cell_value(rowx=3, colx=0) == 'Periodos:' or sheet.cell_value(rowx=3, colx=0) == 'Periodo:'):
            iter_columnas(col_count , sheet, maxima_row, row_count, 5, 4, book, False, file, name.value)
        else:
            iter_columnas(col_count , sheet, maxima_row, row_count, 4, 3, book, False, file, name.value)
